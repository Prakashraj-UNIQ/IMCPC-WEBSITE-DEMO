...
export default function VisionMissionSection () {
  return (
    <section className="w-full py-16 px-20 bg-white">
      <h2 className="text-5xl font-serif font-extrabold text-emerald-950 text-center mb-12">
        Vision & Mission
      </h2>
      <div className="mx-auto space-y-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="flex flex-col justify-center gap-6">
            <h2 className="text-4xl font-bold text-emerald-600">Vision</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="flex flex-col justify-center gap-6 order-2 md:order-1">
            <h2 className="text-4xl font-bold text-emerald-600">Mission</h2>
